...
<NavigationMenu.Root className="NavigationMenuRoot">
            <NavigationMenu.List className="NavigationMenuList">
                <NavigationMenu.Item className='logo'>
                ...
                <NavigationMenu.Item className='features-dropdown'>
                    <NavigationMenu.Trigger className='NavigationMenuTrigger'>
                        Features <CaretDownIcon className="CaretDown" aria-hidden />
                    </NavigationMenu.Trigger>
                    <NavigationMenu.Content className='features-drop-down-content'>
                        <ul>
                            <li className='to-do'>
                                <NavigationMenu.Link href='' className='link'>
                                    <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" className='icon'>
                            ...
                            <li className='calender'>
                                <NavigationMenu.Link href='' className='link'>
                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" className='icon'>
                            ...
                            <li className='reminders'>
                                <NavigationMenu.Link href='' className='link'>
                                    <svg width="13" height="17" xmlns="http://www.w3.org/2000/svg" className='icon'>
                ...
                <NavigationMenu.Item className='Company-drop-down'>
                    <NavigationMenu.Trigger className='NavigationMenuTrigger'>
                        Company <CaretDownIcon className="CaretDown" aria-hidden />
                    </NavigationMenu.Trigger>
                    <NavigationMenu.Content className="company-drop-down-contents">
                        <ul>
                ...
                <NavigationMenu.Item className='careers-header'>
                    <NavigationMenu.Link href='' className='careers-link'>
                        Careers
                    </NavigationMenu.Link>
                </NavigationMenu.Item>
                <NavigationMenu.Item className='about-header'>
                    <NavigationMenu.Link href='' className='about-link'>
                        About
                    </NavigationMenu.Link>
                </NavigationMenu.Item>
                <div className='sign-up-login'>
                <NavigationMenu.Item className='register-header'>
                    <NavigationMenu.Link href='' className='register-link'>
                        Register
                    </NavigationMenu.Link>

                </NavigationMenu.Item>
                <NavigationMenu.Item className='login-header'>
                    <NavigationMenu.Link href='' className='login-link'>
                        Login
                    </NavigationMenu.Link>
                </NavigationMenu.Item>
